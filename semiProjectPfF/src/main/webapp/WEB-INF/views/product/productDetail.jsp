...
<body>
	...
	<main id="order-wrap">
		...
		<div class="left">
			<!-- 구매창 왼쪽 사진 넣는 곳 -->
			<img src="${contextPath}/resources/product_img/${p.productMainPic}" alt="productMainProfile">
		</div>
		<div class="right">
			<!-- 상품 정보 -->
			<div class="top">
				<div class="brandNameBox">
					<a href="${contextPath}" class="aStyle"> <h3 id="brandName">passion for Fashion</h3>
...
<!-- 						</script> -->
	...
	<div class="Infobox">
		<!-- 제품 사진 및 소개 칸 -->
		<div class="imgbox">
			<img src="${contextPath}/resources/product_img/${p.productDetailPic1}"  alt="productDetailPic"> <img src="${contextPath}/resources/product_img/${p.productDetailPic2}"  alt="product"> <img
				src="${contextPath}/resources/product_img/${p.productDetailPic3}"  alt="productDetailPic">
		</div>
		<br>
